...
| kingdoms-infra#4 — [Phase 2] Create deployment scripts | 2 | `M` | `P3` | 16 | kingdoms-infra#2, kingdoms-services#20, ~~kingdoms-infra#1~~ ✅ |
| kingdoms-infra#5 — [Phase 2] Configure monitoring | 2 | `M` | `P3` | 37 | kingdoms-infra#2, ~~kingdoms-infra#1~~ ✅ |
...
| kingdoms-services#20 — [Phase 1] Create deployment scripts | 1 | `S` | `P3` | 16 | kingdoms-services#12, ~~kingdoms-infra#1~~ ✅ |
